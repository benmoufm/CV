...
class CompetenceDetailViewController: UIViewController,
    ...
    private func setupLayout() {
        ...
        evaluationFrame.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -20.0).isActive = true
        evaluationFrame.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 20.0).isActive = true
        ...
        usageDescriptionLabel.rightAnchor.constraint(equalTo: view.rightAnchor).isActive = true
        usageDescriptionLabel.leftAnchor.constraint(equalTo: view.leftAnchor).isActive = true
