...
class SwitchContainerViewController: UIViewController {
    ...
    private func setupLayout() {
        ...
        competenceViewController.view.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -50.0).isActive = true
        ...
        experienceViewController.view.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -50.0).isActive = true
