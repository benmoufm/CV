...
struct CompetenceTableViewModelMapper {
    ...
    func map() -> CompetenceTableViewModel {
        // Titles
        let developmentCell = CompetenceCellViewModelMapper(label: "development_skills_category".localized, isTitleCell: true).map()
        let developmentToolsCell = CompetenceCellViewModelMapper(label: "development_tools_skills_category".localized, isTitleCell: true).map()
        let patternsCell = CompetenceCellViewModelMapper(label: "pattern_skills_category".localized, isTitleCell: true).map()
        let methodsCell = CompetenceCellViewModelMapper(label: "methods_skills_category".localized, isTitleCell: true).map()
        let languageCell = CompetenceCellViewModelMapper(label: "languages_skills_category".localized, isTitleCell: true).map()
        let specialSkillsCell = CompetenceCellViewModelMapper(label: "special_skills_category".localized, isTitleCell: true).map()
